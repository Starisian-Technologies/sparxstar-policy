...
**9.2 Platform-Generated Outputs.** AI-Assisted Outputs generated by Platform systems autonomously — without a specific User prompt and not derived from a specific User's Content — are Platform Content owned by the Company. This includes: (a) Platform-generated Structured Datasets; (b) Semantic Mappings and Curated Lexicons; (c) AI-generated metadata and content classifications; and (d) AI-generated editorial curation, promotional content, and platform communications.
