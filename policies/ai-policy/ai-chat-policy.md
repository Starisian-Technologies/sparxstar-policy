...
Users agree to indemnify, defend, and hold harmless the Company, its officers, directors, employees, agents, licensors, Client Operators, and successors from and against any and all claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys' fees) arising from or relating to any fraudulent, unlawful, grossly negligent, or intentionally wrongful conduct by the User in connection with: (a) use of AI Features in violation of this Policy; (b) generation of AI-Assisted Outputs in response to User prompts that violate applicable law or third-party rights; (c) misrepresentation of AI-Assisted Outputs as human-created works; or (d) use of AI Features that causes demonstrable harm to a third party.
