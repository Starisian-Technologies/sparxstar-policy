...
**6.2.1 Platform License to User for AI-Assisted Outputs.** Subject to the User's compliance with these Master Terms and applicable service terms, the Company grants the User a worldwide, non-exclusive, royalty-free license to use, reproduce, distribute, and create derivative works from AI-Assisted Outputs generated in response to that User's prompts or other User-submitted inputs, as described in the AI Chat and AI Use Policy, to the extent the Company holds any rights in such Outputs and to the extent permitted by applicable law. This license is subject to the restrictions and conditions set forth in the AI Chat and AI Use Policy, including Section 9.
